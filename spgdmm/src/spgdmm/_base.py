...
class ModelBuilder:
    ...
    def fit(
        ...
        **kwargs : Any
        ...
        print("Fitting model... with random seed:", random_seed, sampler_config['random_seed'])
    ...
    def predict_posterior(
        self,
        X_pred: np.ndarray | pd.DataFrame | pd.Series,
        y_pred_obs: np.ndarray | pd.DataFrame | pd.Series | None = None,
        extend_idata: bool = True,
        combined: bool = True,
        predictions: bool = True,
        **kwargs,
        ...
        **kwargs: Additional arguments to pass to pymc.sample_posterior_predictive
        ...
        posterior_predictive_samples = self.sample_posterior_predictive(
            X_pred, extend_idata, combined, y_pred_obs=y_pred_obs, predictions=predictions, **kwargs
        )
